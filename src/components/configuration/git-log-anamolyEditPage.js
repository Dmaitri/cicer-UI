...
// import testData from '../json/git-log-anamoly'
...
//             accessor: 'paths',
//               render: ({value}) =>{
//                   const tagList = value.map(x=>x.path).join(", ")
...
// class GitLogAnamolyEditPage extends React.Component {
//   constructor(props) {
//     super(props);
//     const data = getData();
...
//     } else {
//       this.setState({ pivotBy: ['commit', 'author'], expanded: {} });
//     }
//   }
...
// export default GitLogAnamolyEditPage;
